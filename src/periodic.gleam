// taken from https://github.com/gleam-lang/packages/blob/main/src/packages/periodic.gleam
...
type State(a) {
  State(self: Subject(Message), work: fn() -> Result(a, String), interval: Int)
}
